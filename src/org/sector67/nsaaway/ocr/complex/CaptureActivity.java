...
import org.sector67.nsaaway.ocr.complex.camera.ShutterButton;
...
public final class CaptureActivity extends Activity implements SurfaceHolder.Callback, 
  ...
  private static final String[] CUBE_REQUIRED_LANGUAGES = { 
    "ara", // Arabic
    "eng" //sph for testing, force cube
  };
  ...
  public void onCreate(Bundle icicle) {
    ...
    setContentView(R.layout.activity_complex_ocr);
    ...
    // send the ocr result to the enter plaintext screen
    Button complexOcrContinueButton = (Button) findViewById(R.id.complexOcrContinueButton);
